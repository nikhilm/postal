...
PLTSTDERR="error debug@postal" ip netns exec dhcp-test-client /home/nikhil/racket-8.15/bin/racket -A /home/nikhil/.local/share/racket/ -l errortrace -t main.rkt
